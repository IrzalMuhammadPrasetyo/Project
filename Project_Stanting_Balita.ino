...
//  if (dataNow>=5 || dataNow<15){
//    dataNow=(dataNow-(0.9915*dataNow+0.0386))+dataNow;  
//  }
//  else if (dataNow>=15 || dataNow<26){
//    dataNow=(dataNow-(0.9891*dataNow+0.0655))+dataNow;
//  }
//  else if (dataNow>=26){
//    dataNow=(dataNow-(0.988*dataNow+0.096))+dataNow;
//  }
